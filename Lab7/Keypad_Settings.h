...
//PORT, PIN
#define Keypad_R0			D, 6
#define Keypad_R1			D, 7
#define Keypad_R2			B, 0
#define Keypad_R3			B, 1
#define Keypad_C0			B, 2
#define Keypad_C1			B, 3
#define Keypad_C2			B, 4
#define Keypad_C3			B, 5
//----------------------------------------------//
#endif